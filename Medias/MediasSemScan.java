...
public class MediasSemScan {
    ...
    public static void main(String[] args) {
        ...
        String[] Alunos = {"Marcos", "Yukio", "Tx", "Gabriel", "Caio", "Rivia", "Clara", "Ana", "Vinicius", "Bárbara"};
        ...
        for(int ContadorAlunos = 0; ContadorAlunos < 10; ContadorAlunos++) {
            ...
            for(int ContadorDisciplinas = 0; ContadorDisciplinas < 4; ContadorDisciplinas++) {
                ...
                double Nota = Aleatorio.nextInt();

                Notas[ContadorAlunos][ContadorDisciplinas] = Nota * 10;
